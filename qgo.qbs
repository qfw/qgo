...
Project {
    ...
    property path ide_source_tree: path + "/src/3rdparty/qtcreator"
    ...
    property string sharedSourcesDir: ide_source_tree + "/src/shared"
    ...
    qbsSearchPaths: ["qbs", "src/3rdparty/qtcreator/qbs"]

    references: [
        "share/share.qbs",
        "src/src.qbs",
        "src/3rdparty/qtcreator/src/src.qbs",
        "src/3rdparty/qtcreator/share/share.qbs",
    ]
}
